...
export const validateUserVocation = (req: Request, res: Response, next: NextFunction) => {
...
export const validateUserLevel = (req: Request, res: Response, next: NextFunction) => {
...
export const validateUserPassword = (req: Request, res: Response, next: NextFunction) => {
